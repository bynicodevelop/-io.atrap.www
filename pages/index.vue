            ...
            >
              <div class="sm:text-center lg:text-left">
                ...
                <p
                  class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"
                >
                  Mais saviez-vous qu'il est possible d'automatiser 100% de
                  votre prospection sociale.
                </p>
                <div
          ...
          <div class="lg:col-start-2 lg:pl-8">
            ...
            >
              ...
              <p class="mt-8 text-lg text-gray-500">
                Passez-vous beaucoup de temps créer et programmer vos
              ...
              <div class="mt-5 prose prose-indigo text-gray-500">
                ...
                <p>
                  Avec Atrap.io, on vous donne les outils nécessaire pour créer
                  du contenu facilement.
                </p>
                <p>
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
          <div class="text-lg max-w-prose mx-auto">
            ...
            <p class="mt-8 text-xl text-gray-500 leading-8">
              ...
              Mais vous pouvez vous enregistrer gratuitement à la liste
              d'attente.
            </p>
          </div>
          <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            ...
            <p>
              Pourquoi ne pas réserver votre place pour être le premier à
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
          <div class="text-lg max-w-prose mx-auto">
            ...
            <p class="mt-8 text-xl text-gray-500 leading-8">
              ...
              prospection sociale afin d'amener les prospects dans vos tunnels
              de vente efficacement.
            </p>
          </div>
          <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <p>
