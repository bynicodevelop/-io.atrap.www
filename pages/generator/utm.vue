          ...
          <div class="pt-20">
            ...
            >
              ...
              <p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                Générez vos URLs de tracking facilement et rapidement pour
                suivre vos visiteurs sur votre site Web.
              </p>
              ...
              <p class="mt-6 text-sm text-warm-gray-500 max-w-3xl italic">
                Les champs content un astérisque (*) sont obligatoires pour le
                bon fonctionnement de votre suivi de trafic.
              </p>
              <div class="h-32"></div>
            </div>
          </div>
